...
from psycopg2 import OperationalError as Psycopg2Error  # one of error that raises when DB is not ready
from django.db.utils import OperationalError   # other type of error that raises when DB is not ready
...
class CustomTests(SimpleTestCase):
    ...
    def test_wait_for_db_delay(self, patched_sleep, patched_check):
        ...
        we can add the occurence of the errors as :
            ...
            and then returns a boolean indicating whether the database connection is successful or not
